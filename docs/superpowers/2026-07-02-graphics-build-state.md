...
## RESUME LOG (day 2)
- ROUNDS 7-8 DEPLOYED v1.1.26, SESSION PAUSED HERE (James call): real constellations (101-star catalogue, wheels round Polaris at 54.4N, E-W mirrored to match sun path — documented in sky.js), SEASONAL SOLAR MODEL (solarState: winter 7h/12deg, summer 17h/59deg, equinox==old 0.25/0.75 exactly; ALL literal-time consumers re-anchored — see verify-solar 78 asserts), ACCELERATED MOON (15.5-game-day cycle = year ratio; lunarState seats moon BY phase — new moons dark, crescents on twilight horizons), swimming + river current (3.2b/s x bank; fall damage absorbed by water), paraffin lighthouse beam (one billboarded blade, 22 blocks, mist-coupled; flare moved to lamp). QUEUED AS CHIPS: shadow-edge flicker (may be solar-path vs texel-snap), verify:gl pipeline, Esk flow-field data fix, resume-at-S2c backlog. NOTE for next session: relay/brain NPC schedules use fixed day fractions — cosmetic mismatch with seasonal dark, EVO-side follow-up.
