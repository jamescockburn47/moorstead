...
try{
  net.connect();const socket=Socket.last;socket.onopen();assert.deepEqual(socket.sent[0],{type:'hello',protocol:1,contentVersion:6});
  const init={type:'init',protocol:1,contentVersion:6,minContentVersion:6,freeplay:true,room:FREEPLAY.room,seed:FREEPLAY.seed,epoch:1,revision:0,history:[],checkpoint:false,players:[],vehicleCount:0,count:1};
